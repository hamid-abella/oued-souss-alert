...
// Fichier : src/components/common/Sidebar.jsx
// Description : Navigation latérale avec liens actifs
// =============================================================

import { NavLink } from 'react-router-dom';
import {
  LayoutDashboard, MapPin, Bell,
...
const NAV_ITEMS = [
  ...
  { to: '/indices',  icon: BarChart2,       label: 'Indices'    },
];
    ...
    <aside style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '4px' }}>
          ...
          <span style={{ color: 'var(--color-faible)' }}>Système actif</span>
        </div>
        ENSIASD Taroudant<br />
        SIBD Projet 2025-2026
      </div>
    </aside>
  );
};
